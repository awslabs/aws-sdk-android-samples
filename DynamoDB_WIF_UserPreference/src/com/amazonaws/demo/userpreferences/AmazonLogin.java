...
public class AmazonLogin extends AlertActivity {
    ...
    private class TokenListener implements AuthorizationListener{
        ...
        public void onSuccess(Bundle response) {
            ...
            UserPreferenceDemoActivity.clientManager.login(new AmazonIDP(authManager,authzToken),AmazonLogin.this);
    ...
    protected class AmazonIDP implements WIFIdentityProvider {
        ...
        public String getRoleARN() {
            return UserPreferenceDemoActivity.clientManager.getAmazonRoleARN();
        }
