...
public class FacebookLogin extends AlertActivity {
	...
	public void onResume() {
		...
		// by Facebook is used to control the session
	...
	public void onSessionStateChange(Session session, SessionState state, Exception exception) {
		if (session.isOpened()) {
			...
			S3PersonalFileStore.clientManager.login(new FacebookIDP(), FacebookLogin.this);
	...
	protected class FacebookIDP implements WIFIdentityProvider {
		...
		public String getRoleARN() {
			return S3PersonalFileStore.clientManager.getFacebookRoleARN();
		}
