...
This sample demonstrates enabling guest users to use the AWS IoT APIs to securely publish-to and subscribe-from MQTT topics. Instructions to use AWS IoT with user sign-in can be found [here](./AuthenticatedPubsub.md)
